...
import { ManualEnrollmentModal } from '../features/manual-enrollment/ui/ManualEnrollmentModal';
import { MassiveEnrollmentModal } from '../features/massive-enrollment/ui/MassiveEnrollmentModal';
...
export const EnrollmentSearch: React.FC = () => {
  ...
  const handleManualSuccess = (studentId: number) => {
    ...
    void navigate({ to: `/dashboard/student/${studentId.toString()}/enrollment` });
  };
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <Button variant="outline" onClick={() => { setIsMassiveModalOpen(true); }}>
            Cargar CSV Masivo
          </Button>
